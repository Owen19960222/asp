...
Public Class AccountController
    ...
    Public Function Manage(ByVal message As ManageMessageId?) As ActionResult
        ViewData("StatusMessage") =
            If(message = ManageMessageId.ChangePasswordSuccess, "您的密碼已變更。", _
                If(message = ManageMessageId.SetPasswordSuccess, "已設定您的密碼。", _
                    If(message = ManageMessageId.RemoveLoginSuccess, "已移除外部登入。", _
                        If(message = ManageMessageId.UnknownError, "發生錯誤。", _
                        ""))))
